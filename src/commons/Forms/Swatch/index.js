...
const Swatch = ({
        ...
        return (
            <div
                className={cx(
                    ...
                    checked ? 'border-[1px] border-neutral-700' : '',
                    disabled ? 'border-yellow-400 opacity-40' : 'hover:border-[1px] hover:border-neutral-700',
                )}
            >
                <div
    ...
    return (
        <div
            ...
            className={cx(
                'swift-swatcher-text',
                !disabled ? (checked ? 'border-neutral-800 text-neutral-700 bg-neutral-50' : 'border-neutral-50 text-neutral-700') : '',
                !disabled ? 'hover:border-neutral-500 hover:text-neutral-700 hover:bg-neutral-50' : '',
