...
const SimpleProductTypePrice = ({
    ...
    if (regularPrice.value === finalPrice.value) {
        return (
            <Typography variant={priceLabelVariant} className={cx('price-text', 'text-neutral-400', 'price-case-8', 'font-semibold', textClassName)}>
                {formatPrice(finalPrice.value + otherPrice, finalPrice.currency, currencyCache)}
            </Typography>
        );
    }
    ...
    return (
        <div className={cx('price-case-9 price-text-discount', 'inline-flex', 'flex-col')}>
            {/* case 9 */}
            <Typography variant={priceLabelVariant} className={cx('price-text', 'text-neutral-400', 'font-semibold', textClassName)}>
                {validSpecial
                    ? formatPrice(finalPrice.value + otherPrice, finalPrice.currency, currencyCache)
