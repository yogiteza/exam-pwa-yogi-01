                ...
                {owl_nav ? (
                    <div
                        className={cx('flex', 'justify-between', 'pointer-events-none', {
                            ...
                            'lg:opacity-0 group-hover:opacity-100 absolute w-full top-[50%] -translate-y-[50%] z-[2]':
                    ...
                    >
                        ...
                        >
                            <ChevronLeft className="!w-[24px] !h-6 text-[white]" />
                        </div>
                        <div
                            className={cx(
                                'magezon-slider--button-nav-item',
                        ...
                        >
                            <ChevronRight className="!w-[24px] !h-6 text-[white]" />
                        </div>
                    </div>
                ) : null}
