...
const Copyright = (props) => {
    ...
    return (
        ...
        >
            <span className={cx(
                'text-base', 'font-medium', 'leading-5', 'text-neutral-500 desktop:text-neutral-200',
            )}
            >
                ...
                version === 'pwa_footer_v2' ? (
                    <div className="flex flex-row gap-4">
                        <Link href="/privacy-policy-cookie-restriction-mode">
                            <span className={cx('text-base', 'font-medium', 'leading-5', 'text-neutral-200', 'cursor-pointer')}>
